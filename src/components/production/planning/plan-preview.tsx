    ...
    return (
        <div className="space-y-6 pb-8">
            ...
            <section id="guide" className="ff-card scroll-mt-5 p-6 sm:p-8">
                <div className="flex items-start gap-3"><span className="grid size-10 shrink-0 place-items-center rounded-xl bg-[#9be3c3]"><Lightbulb className="size-5" aria-hidden="true" /></span><div><p className="ff-eyebrow">02 · Creative guide</p><h3 className="ff-display mt-2 text-2xl font-semibold">The details that keep it feeling like one video</h3><p className="mt-2 text-sm leading-6 text-muted-foreground">FinalFrame will use these choices as the reference while it plans each take.</p></div></div>
            ...
            <section id="parts" className="ff-card scroll-mt-5 p-6 sm:p-8">
                <div className="flex items-start gap-3"><span className="grid size-10 shrink-0 place-items-center rounded-xl bg-[#ff9e9e]"><MessageSquareText className="size-5" aria-hidden="true" /></span><div><p className="ff-eyebrow">03 · Parts and takes</p><h3 className="ff-display mt-2 text-2xl font-semibold">A clear path from beginning to end</h3><p className="mt-2 text-sm leading-6 text-muted-foreground">Each take is planned independently so you can revise one moment without losing the rest.</p></div></div>
