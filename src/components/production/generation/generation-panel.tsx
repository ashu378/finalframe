...
function statusClasses(tone: ReturnType<typeof statusCopy>['tone']): string {
    if (tone === 'success') return 'bg-[#9be3c3] text-[hsl(var(--success))]';
    if (tone === 'danger') return 'bg-[#ff9e9e] text-[#ff9e9e]';
    if (tone === 'warm') return 'bg-[#86a7ff] text-foreground';
