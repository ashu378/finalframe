  ...
  return (
    <div className="ff-card overflow-hidden p-3 sm:p-5">
      <div className="grid gap-4 lg:grid-cols-[1.12fr_.88fr]">
        <div className="relative min-h-[320px] overflow-hidden rounded-[1rem] bg-[#101722] sm:min-h-[430px]">
          ...
          <div className="absolute bottom-5 left-5 right-5 flex items-end justify-between gap-4 text-[#eaf0fa]">
            <div><p className="text-xs font-semibold uppercase tracking-[.14em] text-[#86a7ff]">Preview · {item.type}</p><p className="mt-2 max-w-sm text-xl font-semibold">{item.title}</p></div>
            <span className="grid size-11 shrink-0 place-items-center rounded-full bg-[#eaf0fa] text-[#0b0d12]"><Film className="size-5" /></span>
          </div>
        </div>
